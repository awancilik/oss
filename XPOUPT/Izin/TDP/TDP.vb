...
Namespace OSS
  ...
  Public Property NoIjin() As String
        ...
        Public Property PerusahaanNama() As String
            ...
            End Set
        End Property
        Dim fPerusahaanBentukID As TDPtBentuk
        Public Property PerusahaanBentukID() As TDPtBentuk
            Get
                Return fPerusahaanBentukID
            End Get
            Set(ByVal value As TDPtBentuk)
                SetPropertyValue(Of TDPtBentuk)("PerusahaanBentukID", fPerusahaanBentukID, value)
            End Set
        End Property
        ...
        Public Property rek_id() As Guid
            ...
            End Set
        End Property
        Dim fPenerimaTDPNama As String
        Public Property PenerimaTDPNama() As String
            Get
                Return fPenerimaTDPNama
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("PenerimaTDPNama", fPenerimaTDPNama, value)
            End Set
        End Property
        Dim fPenerimaTDPAlamat As String
        Public Property PenerimaTDPAlamat() As String
            Get
                Return fPenerimaTDPAlamat
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("PenerimaTDPAlamat", fPenerimaTDPAlamat, value)
            End Set
        End Property
        Dim fMerk As String
        ...
        Public ReadOnly Property TDPJenisKLUI() As XPCollection(Of TDPJenisKLUI)
            Get
                Return GetCollection(Of TDPJenisKLUI)("TDPJenisKLUI")
            End Get
        End Property
        <Association("TDP-TDPBank")> _
       Public ReadOnly Property TDPBank() As XPCollection(Of TDPbank)
            Get
                Return GetCollection(Of TDPbank)("TDPBank")
            End Get
        End Property
