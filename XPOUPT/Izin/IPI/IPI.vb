...
Namespace OSS
	...
	Public Class IPI
		...
		Public Property NoIzin() As String
			...
			End Set
		End Property
		Dim fNoIzinLama As String
		<Size(45)> _
		Public Property NoIzinLama() As String
			Get
				Return fNoIzinLama
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("NoIzinLama", fNoIzinLama, value)
			End Set
        End Property
        Dim fTglIzinLama As Date
        Public Property TglIzinLama() As Date
            Get
                Return fTglIzinLama
            End Get
            Set(ByVal value As Date)
                SetPropertyValue(Of Date)("TglIzinLama", fTglIzinLama, value)
            End Set
        End Property
		...
		Public Property LuasGudang() As Integer
			...
			End Set
		End Property
		Dim fLuasBangunan As Integer
		Public Property LuasBangunan() As Integer
			Get
				Return fLuasBangunan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("LuasBangunan", fLuasBangunan, value)
			End Set
		End Property
		Dim fTKIPriaSebelumPerluasan As Integer
		Public Property TKIPriaSebelumPerluasan() As Integer
			Get
				Return fTKIPriaSebelumPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("TKIPriaSebelumPerluasan", fTKIPriaSebelumPerluasan, value)
			End Set
		End Property
		Dim fTKIPriaSesudahPerluasan As Integer
		Public Property TKIPriaSesudahPerluasan() As Integer
			Get
				Return fTKIPriaSesudahPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("TKIPriaSesudahPerluasan", fTKIPriaSesudahPerluasan, value)
			End Set
		End Property
		Dim fTKIWanitaSebelumPerluasan As Integer
		Public Property TKIWanitaSebelumPerluasan() As Integer
			Get
				Return fTKIWanitaSebelumPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("TKIWanitaSebelumPerluasan", fTKIWanitaSebelumPerluasan, value)
			End Set
		End Property
		Dim fTKIWanitaSesudahPerluasan As Integer
		Public Property TKIWanitaSesudahPerluasan() As Integer
			Get
				Return fTKIWanitaSesudahPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("TKIWanitaSesudahPerluasan", fTKIWanitaSesudahPerluasan, value)
			End Set
		End Property
		Dim fJumlahTKAsing As Integer
		Public Property JumlahTKAsing() As Integer
			Get
				Return fJumlahTKAsing
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("JumlahTKAsing", fJumlahTKAsing, value)
			End Set
		End Property
		Dim fNegaraAsalTKAsing As String
		Public Property NegaraAsalTKAsing() As String
			Get
				Return fNegaraAsalTKAsing
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("NegaraAsalTKAsing", fNegaraAsalTKAsing, value)
			End Set
		End Property
		Dim fKeahlianTKAsing As String
		Public Property KeahlianTKAsing() As String
			Get
				Return fKeahlianTKAsing
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("KeahlianTKAsing", fKeahlianTKAsing, value)
			End Set
		End Property
		Dim fJangkaWaktuTKasing As String
		<Size(10)> _
		Public Property JangkaWaktuTKasing() As String
			Get
				Return fJangkaWaktuTKasing
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("JangkaWaktuTKasing", fJangkaWaktuTKasing, value)
			End Set
		End Property
		Dim fKapasitasSebelumPerluasan As Integer
		Public Property KapasitasSebelumPerluasan() As Integer
			Get
				Return fKapasitasSebelumPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("KapasitasSebelumPerluasan", fKapasitasSebelumPerluasan, value)
			End Set
		End Property
		Dim fKapasitasSesudahPerluasan As Integer
		Public Property KapasitasSesudahPerluasan() As Integer
			Get
				Return fKapasitasSesudahPerluasan
			End Get
			Set(ByVal value As Integer)
				SetPropertyValue(Of Integer)("KapasitasSesudahPerluasan", fKapasitasSesudahPerluasan, value)
			End Set
		End Property
		...
		Public Property JenisIndustri() As String
			...
			End Set
		End Property
		Dim fPenerimaIPINama As String
		<Size(50)> _
		Public Property PenerimaIPINama() As String
			Get
				Return fPenerimaIPINama
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("PenerimaIPINama", fPenerimaIPINama, value)
			End Set
		End Property
		Dim fPenerimaIPIAlamat As String
		<Size(150)> _
		Public Property PenerimaIPIAlamat() As String
			Get
				Return fPenerimaIPIAlamat
			End Get
			Set(ByVal value As String)
				SetPropertyValue(Of String)("PenerimaIPIAlamat", fPenerimaIPIAlamat, value)
			End Set
		End Property
		...
		Public Property rek_id() As Guid
			...
			End Set
        End Property
        Dim fTujuanIndustri As String
        Public Property TujuanIndustri() As String
            Get
                Return fTujuanIndustri
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("TujuanIndustri", fTujuanIndustri, value)
            End Set
        End Property
        ...
        <Association("IPI-IPIDetail")> _
         Public ReadOnly Property IPIDetail() As XPCollection(Of IPIDetail)
            Get
                Return GetCollection(Of IPIDetail)("IPIDetail")
            End Get
        End Property
