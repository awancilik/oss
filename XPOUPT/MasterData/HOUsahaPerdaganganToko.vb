...
Namespace OSS
	...
	Public Class HOUsahaPerdaganganToko
		Inherits XPLiteObject
		Dim fHOUsahaPerdaganganTokoID As Guid
		<Key(true)> _
		Public Property HOUsahaPerdaganganTokoID() As Guid
			Get
				Return fHOUsahaPerdaganganTokoID
			End Get
			Set(ByVal value As Guid)
				SetPropertyValue(Of Guid)("HOUsahaPerdaganganTokoID", fHOUsahaPerdaganganTokoID, value)
			End Set
		End Property
