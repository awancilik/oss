<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="IUIPemeriksaan.aspx.vb" Inherits="Utility_Izin_IUIPemeriksaan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <h1>
        Pemeriksaan Izin Usaha Industri</h1>
    <table>
        <tr>
            <td>
    ...
    <asp:DetailsView ID="imbPemeriksaanDetailsView" runat="server" DataSourceID="iuiPemeriksaanXpoDataSource"
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Tanggal Pemeriksaan : ">
                <InsertItemTemplate>
                    <dxe:ASPxDateEdit ID="tanggalPemeriksaanASPxDateEdit" runat="server" Date='<%# Bind("IUIPemeriksaanTanggal") %>'
