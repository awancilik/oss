...
Partial Class Utility_Izin_IUI_IUIRetribusi
    ...
    Protected Sub iuiPembayaranDetailsView_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DetailsViewUpdateEventArgs) Handles iuiPembayaranDetailsView.ItemUpdating
        e.NewValues.Item("RetribusiTerbilang") = Terbilang(e.NewValues.Item("Retribusi").ToString)
    End Sub

    Protected Sub cetakSKRDASPxButton_Click(ByVal sender As Object, ByVal e As EventArgs)
