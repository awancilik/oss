<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="HOSerahTerima.aspx.vb" Inherits="Utility_Izin_HO_HOSerahTerima" Title="HO Serah Terima" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <br />
    <br />
    <dxrp:ASPxRoundPanel ID="HOASPxRoundPanel" runat="server" HeaderText="Nomor Izin"
        Width="100%">
        <PanelCollection>
            <dxp:PanelContent runat="server">
                <asp:DetailsView ID="IzinDetailsView" runat="server" DataSourceID="HOXpoDataSource"
                    DataKeyNames="HOID" AutoGenerateRows="false" CssClass="dataprop" GridLines="None">
                    <Fields>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <dxe:ASPxButton ID="editASPxButton" runat="server" Text="Serah Terima HO" CommandName="Edit">
                                </dxe:ASPxButton>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="NoIzin :">
                            <ItemTemplate>
                                <dxe:ASPxLabel ID="NoIzinLabelASPxLabel" runat="Server" Text='<%#Eval("NoIzin") %>'>
                                </dxe:ASPxLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                               <%-- <dxe:ASPxTextBox ID="NoIzinTextBoxASPxTextBox" runat="Server" Width="170px" Text='<%#Eval("NoIzin") %>'>
                                </dxe:ASPxTextBox>--%>
                            </EditItemTemplate>
                            <ItemStyle CssClass="field" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Penerima : ">
                            <ItemTemplate>
                                <dxe:ASPxLabel ID="penerimaHONamaASPxLabel" runat="server" Text='<%# Eval("PenerimaHONama") %>'>
                                </dxe:ASPxLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <dxe:ASPxTextBox ID="penerimaHONamaASPxTextBox" runat="server" Width="170px" Text='<%# Bind("PenerimaHONama") %>'>
                                </dxe:ASPxTextBox>
                            </EditItemTemplate>
                            <ItemStyle CssClass="field" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Alamat : ">
                            <ItemTemplate>
                                <dxe:ASPxLabel ID="penerimaHOAlamatASPxLabel" runat="server" Text='<%# Eval("PenerimaHOAlamat") %>'>
                                </dxe:ASPxLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <dxe:ASPxTextBox ID="penerimaHOAlamatASPxTextBox" Width="170px" runat="server" Text='<%# Bind("PenerimaHOAlamat") %>'>
                                </dxe:ASPxTextBox>
                            </EditItemTemplate>
                            <ItemStyle CssClass="field" />
                        </asp:TemplateField>
