<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="SIUPMaintenance.aspx.vb" Inherits="Utility_Izin_SIUPMaintenance" Title="Untitled Page" %>
...
return MaksudGridView.GetFocusedRowIndex();
   ...
   <%-- <dx:XpoDataSource ID="BentukXpoDataSource" runat="server" TypeName="Bisnisobjek.OSS.SIUPtBentuk">
    ...
    <dx:XpoDataSource ID="StatusTempatXpoDataSource" runat="server" TypeName="Bisnisobjek.OSS.SIUPStatus">
    </dx:XpoDataSource>--%>
    ...
    <dxwgv:ASPxGridView ID="MaksudGridView" ClientInstanceName="MaksudGridView" DataSourceID="MaksudXpoDataSource"
        runat="server" AutoGenerateColumns="False" KeyFieldName="SIUPMaksudID">
        <Columns>
            <dxwgv:GridViewDataTextColumn FieldName="SIUPMaksudID" ReadOnly="True" Visible="false"
                VisibleIndex="0">
    ...
    <dxwgv:ASPxGridView ID="StatusTempatGridView" ClientInstanceName="StatusTempatGridView" DataSourceID="StatusTempatXpoDataSource"
        runat="server" AutoGenerateColumns="False" KeyFieldName="SIUPStatusID">
        <Columns>
            <dxwgv:GridViewDataTextColumn FieldName="SIUPStatusID" ReadOnly="True" Visible="False"
                VisibleIndex="0">
            </dxwgv:GridViewDataTextColumn>
