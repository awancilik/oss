<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="SIUPPembayaran.aspx.vb" Inherits="Utility_Izin_SIUP_SIUPPembayaran"
    Title="SIUP Pembayaran" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:DetailsView ID="SIUPDetailView" runat="server" GridLines="none" CssClass="dataprop"
        AutoGenerateRows="false" Visible="false" DataSourceID="SIUPXpoDataSource" DataKeyNames="SIUPID">
