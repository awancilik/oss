<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="TDP.aspx.vb" Inherits="Utility_Izin_TDP" Title="Data Izin TDP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <dx:XpoDataSource ID="MaksudXpoDataSource" runat="server" TypeName="Bisnisobjek.OSS.TDPMaksud">
        <%--Criteria="Maksud like 'Memperoleh TDP%'">--%>
    </dx:XpoDataSource>
    ...
    <dx:XpoDataSource ID="TDPJenisKLUIlXpoDataSource" runat="server" TypeName="Bisnisobjek.OSS.TDPJenisKLUI"
        Criteria="[TDPID!Key]=?">
        <CriteriaParameters>
            <asp:SessionParameter name="newparameter" sessionfield="TDPID" />
        </CriteriaParameters>
    ...
    <dx:XpoDataSource ID="TDPBankXpoDataSource" runat="server" TypeName="Bisnisobjek.OSS.TDPbank"
        Criteria="[TDPID!Key]=?">
        <CriteriaParameters>
            <asp:SessionParameter name="newparameter" sessionfield="TDPID" />
        </CriteriaParameters>
    ...
    <dxcb:ASPxCallback ID="TDPCallback" runat="server">
    </dxcb:ASPxCallback>
                        ...
                        <ContentTemplate>
                            <center>
                                <dxe:ASPxComboBox ID="MaksudASPxComboBox" runat="server" ClientInstanceName="MaksudComboBox"
                                    DataSourceID="MaksudXpoDataSource" Width="250px" ValueField="TDPMaksudID" TextField="Maksud"
    ...
    <br />
    <asp:DetailsView ID="TDPDetailView" runat="server" DataSourceID="TDPXpoDataSource"
        DataKeyNames="TDPID" GridLines="None" CssClass="dataprop" AutoGenerateRows="false"
        Visible="false">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Bidang Usaha (sesuai KLUI)">
                ...
                <EditItemTemplate>
                    ...
                    <dxwgv:ASPxGridView ID="KLUIASPxGridView" runat="server" ClientInstanceName="KLUIGridView"
                        DataSourceID="TDPJenisKLUIlXpoDataSource" AutoGenerateColumns="False" KeyFieldName="TDPJENISKLUIID"
                        OnRowInserting="KLUIASPxGridView_RowInserting">
                        <SettingsBehavior AllowFocusedRow="true" />
                        <Columns>
                            <dxwgv:GridViewDataTextColumn FieldName="TDPJENISKLUIID" ReadOnly="True" Visible="False"
                                VisibleIndex="0">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="TDPID!Key" Visible="False" VisibleIndex="0">
                            </dxwgv:GridViewDataTextColumn>
            ...
            <asp:TemplateField HeaderText="Hubungan Dengan Bank">
                <ItemStyle CssClass="field" />
                <EditItemTemplate>
                    <dxm:ASPxMenu ID="BankASPxMenu" runat="server">
                        <Items>
                        ...
                        <ClientSideEvents ItemClick="function(s, e){
                        if(e.item.name=='New'){
                        TDPBankGridView.AddNewRow();
                        }else{
                        if(e.item.name=='Edit'){
                                TDPBankGridView.StartEditRow(TDPBankGridView.GetFocusedRowIndex());
                            }else{
                            TDPBankGridView.DeleteRow(TDPBankGridView.GetFocusedRowIndex());
                            }
                        }
                        }" />
                    </dxm:ASPxMenu>
                    <dxwgv:ASPxGridView ID="TDPBankASPxGridView" runat="server" ClientInstanceName="TDPBankGridView"
                        DataSourceID="TDPBankXpoDataSource" KeyFieldName="TDPBankID" AutoGenerateColumns="False"
                        OnRowInserting="TDPBankASPxGridView_RowInserting">
                        <SettingsBehavior AllowFocusedRow="true" />
                        <SettingsEditing PopupEditFormWidth="340px" Mode="PopupEditForm" PopupEditFormHorizontalAlign="WindowCenter"
                            PopupEditFormVerticalAlign="WindowCenter" />
                        <Columns>
                            <dxwgv:GridViewDataTextColumn FieldName="TDPBankID" ReadOnly="True" Visible="False"
                                VisibleIndex="0">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="TDPID!Key" Visible="False" VisibleIndex="1">
                            </dxwgv:GridViewDataTextColumn>
