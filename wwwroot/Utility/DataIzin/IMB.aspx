<%@ Page Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false"
    CodeFile="IMB.aspx.vb" Inherits="Utility_DataIzin_IMB" Title="IMB" %>
...
return IMBGridView.GetFocusedRowIndex();}
    ...
    <dxwgv:ASPxGridView ID="IMBGridView" ClientInstanceName="IMBGridView" runat="server"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn FieldName="NoIjin" Caption="Nomor Ijin" VisibleIndex="1" Width="140px">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataDateColumn FieldName="TglDikeluarkan" Caption="Tanggal Dikeluarkan" VisibleIndex="2" Visible="False"
                Width="140px">
                <EditFormSettings Visible="True" />
            ...
            <dxwgv:GridViewDataTextColumn FieldName="NoLama" VisibleIndex="4" Caption="Nomor Lama" Visible="False"
                Width="140px">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn FieldName="NoKTP" VisibleIndex="6" Caption="Nomor KTP" Visible="False"
                Width="140px">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataComboBoxColumn FieldName="KabupatenID" Caption="Kabupaten" VisibleIndex="13" Visible="False">
            ...
            <dxwgv:GridViewDataTextColumn FieldName="KodePos" VisibleIndex="14" Caption="Kodepos" Visible="False">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="Telp" VisibleIndex="15" Caption="Telpon" Visible="False">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="Fax" VisibleIndex="16" Visible="False">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataComboBoxColumn FieldName="TujuanID" VisibleIndex="17" Visible="False" Caption="Tujuan">
                <PropertiesComboBox DataSourceID="TujuanXpoDataSource" ValueField="TujuanID" TextField="TujuanIMB"
                    ValueType="System.String">
                </PropertiesComboBox>
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataComboBoxColumn>
            <dxwgv:GridViewDataComboBoxColumn FieldName="PelaksanaID" VisibleIndex="18" Visible="False" Caption="Pelaksana">
                <PropertiesComboBox DataSourceID="PelaksanaXpoDataSource" ValueField="PelaksanaID"
                    TextField="Pelaksana" ValueType="System.String">
                </PropertiesComboBox>
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataComboBoxColumn>
            <dxwgv:GridViewDataTextColumn FieldName="lksAlamat" VisibleIndex="3" Visible="False" Caption="Lokasi Alamat">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="lksRT" VisibleIndex="3" Visible="False" Caption="Lokasi RT">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="lksRW" VisibleIndex="3" Visible="False" Caption="Lokasi RW">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="lksKelurahanID" VisibleIndex="6" Visible="False" Caption="Lokasi Kelurahan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="lksKodePos" VisibleIndex="6" Visible="False" Caption="Lokasi Kodepos">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="NoSertifikat" VisibleIndex="6" Visible="False" Caption="Nomor Sertifikat">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="Luas" VisibleIndex="6" Visible="False">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataComboBoxColumn FieldName="StatusTanahID" VisibleIndex="26" Visible="False" Caption="Status Tanah">
            ...
            <dxwgv:GridViewDataComboBoxColumn FieldName="JenisBangunanID" VisibleIndex="27" Visible="False" Caption="Jenis Bangunan">
            ...
            <dxwgv:GridViewDataTextColumn FieldName="NoPersil" VisibleIndex="6" Visible="False" Caption="Nomor Persil">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="PmlkTanah" VisibleIndex="6" Visible="False" Caption="Pemilik Tanah">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="PmlkSertifikat" VisibleIndex="6" Visible="False" Caption="Pemilik Sertifikat">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn FieldName="PenutupKap" VisibleIndex="6" Visible="False" Caption="Penutup Kap">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="Jarak" VisibleIndex="6" Visible="False">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="NamaJalan" VisibleIndex="6" Visible="False" Caption="Nama Jalan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="NomorSK" VisibleIndex="6" Visible="False" Caption="Nomor SK">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn FieldName="LuasBangunan" VisibleIndex="3" Visible="False" Caption="Luas Bangunan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="FungsiBangunan" VisibleIndex="3" Visible="False" Caption="Fungsi Bangunan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="GSP" VisibleIndex="3" Visible="False" Caption="Garis Sepadan Pagar">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="GSB" VisibleIndex="3" Visible="False" Caption="Garis Sepadan Bangunan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="KDB" VisibleIndex="3" Visible="False" Caption="Koefisien Dasar Bangunan ">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn FieldName="NilaiBangunan" VisibleIndex="3" Visible="False" Caption="Nilai Bangunan">
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataComboBoxColumn FieldName="PerusahaanID" VisibleIndex="3" Visible="False" Caption="Nama Perusahaan">
                <PropertiesComboBox DataSourceID="PerusahaanXpoDataSource" ValueField="PerusahaanID"
                    TextField="NamaPerusahaan" ValueType="System.String">
                </PropertiesComboBox>
                <EditFormSettings Visible="True" />
            </dxwgv:GridViewDataComboBoxColumn>
        </Columns>
