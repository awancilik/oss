<%@ Page Language="VB" MasterPageFile="~/MasterReportPage.master" AutoEventWireup="false"
    CodeFile="JmlIzinLokasi.aspx.vb" Inherits="JmlIzinLokasi" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <crystalReport:CrystalReportSource ID="LokasiJmlIzinReportSource" runat="server">
    ...
    <div class="reportViewer" style="background-color: #f4f4f4; width: 1%; overflow: visible;">
        <crystalReport:CrystalReportViewer ID="LokasiJmlIzinReportViewer" runat="server" ReportSourceID="LokasiJmlIzinReportSource"
