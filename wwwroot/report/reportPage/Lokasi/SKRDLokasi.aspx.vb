...
Partial Class SKRDLokasi
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\Lokasi\SKRD.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/Lokasi/SKRDLokasi.aspx"
            End Get
        End Property
    ...
    Protected Sub SKRDReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SKRDLokasiReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(SKRDLokasiReportSource, CrystalReportSource)
        ...
        Me.SKRDLokasiReportViewer.ReportSource = rs
        Me.SKRDLokasiReportViewer.RefreshReport()
    End Sub
