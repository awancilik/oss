...
Partial Class RetribusiBulananLokasi
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/Lokasi/RetribusiBulananLokasi.aspx"
            End Get
        End Property
    ...
    Protected Sub IMBRetribusiBulanan_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles LokasiRetribusiBulananReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(LokasiRetribusiBulananReportSource, CrystalReportSource)
        ...
        Me.LokasiRetribusiBulananReportViewer.ReportSource = rs
        Me.LokasiRetribusiBulananReportViewer.RefreshReport()
    End Sub
