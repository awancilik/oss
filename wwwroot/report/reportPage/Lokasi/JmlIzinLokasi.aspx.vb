...
Partial Class JmlIzinLokasi
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\Lokasi\LokasiJmlIzin.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/Lokasi/JmlIzinLokasi.aspx"
            End Get
        End Property
    ...
    Protected Sub IMBJmlIzin_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles LokasiJmlIzinReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(LokasiJmlIzinReportSource, CrystalReportSource)
        ...
        Me.LokasiJmlIzinReportViewer.ReportSource = rs
        Me.LokasiJmlIzinReportViewer.RefreshReport()
    End Sub
