...
Partial Class report_reportPage_IPI_KeputusanIzin
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IPI\KeputusanIzin.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../reportPage/IPI/KeputusanIzin.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles KeputusanIzinIPIReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(KeputusanIzinIPIReportSource, CrystalReportSource)

        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)

        Me.KeputusanIzinIPIReportViewer.ReportSource = rs
        Me.KeputusanIzinIPIReportViewer.RefreshReport()
    End Sub
