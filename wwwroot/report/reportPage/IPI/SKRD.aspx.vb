...
Partial Class SKRD
    ...
    Private Const REPORT_FILE_NAME As String = "report\source\IPI\SKRD.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../reportPage/IPI/SKRD.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SKRDReportSource.Init
