...
Partial Class RetribusiBulananIUI
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IUI\IUIRetribusiBulanan.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/IUI/RetribusiBulananIUI.aspx"
            End Get
        End Property
    ...
    Protected Sub IMBRetribusiBulanan_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles iuiRetribusiBulananReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(iuiRetribusiBulananReportSource, CrystalReportSource)
        ...
        Me.iuiRetribusiBulananReportViewer.ReportSource = rs
        Me.iuiRetribusiBulananReportViewer.RefreshReport()
    End Sub
