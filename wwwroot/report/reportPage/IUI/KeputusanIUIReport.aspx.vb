...
Partial Class KeputusanIUIReport
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IUI\KeputusanIzin.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../reportPage/IUI/KeputusanIUIReport.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles KeputusanIUIReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(KeputusanIUIReportSource, CrystalReportSource)

        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)

        Me.KeputusanIUIReportViewer.ReportSource = rs
        Me.KeputusanIUIReportViewer.RefreshReport()
    End Sub
