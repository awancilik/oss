...
Partial Class JmlIUI
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IUI\IUIJmlIzin.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/IUI/JmlIUI.aspx"
            End Get
        End Property
    ...
    Protected Sub iuiJmlIzin_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles iuiJmlIzinReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(iuiJmlIzinReportSource, CrystalReportSource)
        ...
        Me.iuiJmlIzinReportViewer.ReportSource = rs
        Me.iuiJmlIzinReportViewer.RefreshReport()
    End Sub
