...
Partial Class SKRDIUI
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IUI\SKRD.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/IUI/SKRDIUI.aspx"
            End Get
        End Property
    ...
    Protected Sub SKRDReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SKRDIUIReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(SKRDIUIReportSource, CrystalReportSource)
        ...
        Me.SKRDIUIReportViewer.ReportSource = rs
        Me.SKRDIUIReportViewer.RefreshReport()
    End Sub
