...
Partial Class TDIJmlIzinReport
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\TDI\daftarbulanan.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/TDI/JmlIzin.aspx"
            End Get
        End Property
    ...
    Protected Sub TDIJmlIzin_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles TDIJmlIzin.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(TDIJmlIzin, CrystalReportSource)

        rs.ReportDocument.SetParameterValue("Bulan", parameters.Bulan)
        rs.ReportDocument.SetParameterValue("Tahun", parameters.Tahun)

        Me.TDIJmlIzinReportViewer.ReportSource = rs
        Me.TDIJmlIzinReportViewer.RefreshReport()
    End Sub
End Class
