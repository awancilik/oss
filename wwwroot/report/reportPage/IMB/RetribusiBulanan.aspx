...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <crystalReport:CrystalReportSource ID="IMBRetribusiBulanan" runat="server">
    ...
    <div class="reportViewer" style="background-color: #f4f4f4; width: 1%; overflow: visible;">
        <crystalReport:CrystalReportViewer ID="IMBRetribusiBulananReportViewer" runat="server"
            ReportSourceID="IMBRetribusiBulanan" AutoDataBind="true" DisplayGroupTree="False"
