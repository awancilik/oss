<%@ Page Language="VB" MasterPageFile="~/MasterReportPage.master" AutoEventWireup="false"
    CodeFile="Permohonan.aspx.vb" Inherits="PermohonanReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <crystalReport:CrystalReportSource ID="Permohonan" runat="server">
        <Report FileName="D:\Visual Studio 2005\Projects\OSS\wwwroot\report\reportPage\Permohonan Perijinan.rpt">
        </Report>
    </crystalReport:CrystalReportSource>
    <div class="reportViewer" style="background-color: #f4f4f4; width: 1%; overflow: visible;">
        <crystalReport:CrystalReportViewer ID="PermohonanReportViewer" runat="server" ReportSourceID="Permohonan"
