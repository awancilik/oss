...
Partial Class report_reportPage_IPT_BuktiPembayaran
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IPT\TandaBuktiPembayaran.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/IPT/BuktiPembayaran.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles TandaBuktiPembayaranIPTReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(TandaBuktiPembayaranIPTReportSource, CrystalReportSource)
        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)
        Me.TandaBuktiPembayaranReportIPTViewer.ReportSource = rs
        Me.TandaBuktiPembayaranReportIPTViewer.RefreshReport()
    End Sub
End Class
