...
Partial Class RekapitulasiIPT
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IPT\Rekapitulasi.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Public ReadOnly Property Bulan() As String
            Get
                Return _bulan
            End Get
        End Property

        Public ReadOnly Property Tahun() As String
            Get
                Return _tahun
            End Get
        End Property
        ...
        Public Sub New(ByVal bulan As String, ByVal tahun As String)
            _bulan = bulan
            Me._tahun = tahun
        End Sub
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../reportPage/IPT/RekapitulasiIPT.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles RekapitulasiIPTReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(RekapitulasiIPTReportSource, CrystalReportSource)

        rs.ReportDocument.SetParameterValue("Bulan", parameters.Bulan)
        rs.ReportDocument.SetParameterValue("Tahun", parameters.Tahun)
        Me.RekapitulasiIPTReportViewer.ReportSource = rs
        Me.RekapitulasiIPTReportViewer.RefreshReport()
    End Sub
