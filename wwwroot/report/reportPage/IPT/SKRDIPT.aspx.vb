...
Partial Class SKRDIPT
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\IPT\SKRD.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/IPT/SKRDIPT.aspx"
            End Get
        End Property
    ...
    Protected Sub SKRDReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SKRDIPTReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(SKRDIPTReportSource, CrystalReportSource)
        ...
        Me.SKRDIPTReportViewer.ReportSource = rs
        Me.SKRDIPTReportViewer.RefreshReport()
    End Sub
