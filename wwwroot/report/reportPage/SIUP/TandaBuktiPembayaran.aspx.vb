...
Partial Class TBP
    ...
    Private Const REPORT_FILE_NAME As String = "report\source\SIUP\TandaBuktiPembayaran.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../reportPage/SIUP/TandaBuktiPembayaran.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles TandaBuktiPembayaranSIUPReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(TandaBuktiPembayaranSIUPReportSource, CrystalReportSource)
        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)
        Me.TandaBuktiPembayaranReportSIUPViewer.ReportSource = rs
        Me.TandaBuktiPembayaranReportSIUPViewer.RefreshReport()
    End Sub
End Class
