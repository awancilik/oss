...
Partial Class RetribusiBulanan
    ...
    Private Const REPORT_FILE_NAME As String = "report\source\SIUP\SIUPRetribusiBulanan.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/SIUP/RetribusiBulanan.aspx"
            End Get
        End Property
    ...
    Protected Sub SIUPRetribusiBulanan_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SIUPRetribusiBulanan.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(SIUPRetribusiBulanan, CrystalReportSource)
        ...
        Me.SIUPRetribusiBulananReportViewer.ReportSource = rs
        Me.SIUPRetribusiBulananReportViewer.RefreshReport()
    End Sub
End Class
