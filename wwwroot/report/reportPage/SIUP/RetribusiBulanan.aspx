<%@ Page Language="VB" MasterPageFile="~/MasterReportPage.master" AutoEventWireup="false"
    CodeFile="RetribusiBulanan.aspx.vb" Inherits="RetribusiBulanan"
    Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <crystalReport:CrystalReportSource ID="SIUPRetribusiBulanan" runat="server">
        <Report FileName="D:\Visual Studio 2005\Projects\OSS\wwwroot\report\SIUP\SIUPRetribusiBulanan.rpt">
        </Report>
    </crystalReport:CrystalReportSource>
    <div class="reportViewer" style="background-color: #f4f4f4; width: 1%; overflow: visible;">
        <crystalReport:CrystalReportViewer ID="SIUPRetribusiBulananReportViewer" runat="server"
            ReportSourceID="SIUPRetribusiBulanan" AutoDataBind="true" DisplayGroupTree="False"
