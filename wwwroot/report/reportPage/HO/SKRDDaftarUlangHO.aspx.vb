...
Partial Class SKRDDaftarUlangHO
    Inherits ReportPageBase
    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\HO\SKRDDaftarUlangHO.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/HO/SKRDDaftarUlangHO.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles SKRDDaftarUlangHOReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(SKRDDaftarUlangHOReportSource, CrystalReportSource)

        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)

        Me.SKRDDaftarUlangHOReportViewer.ReportSource = rs
        Me.SKRDDaftarUlangHOReportViewer.RefreshReport()
    End Sub
