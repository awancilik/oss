...
Partial Class TBPUlangHO
    Inherits ReportPageBase

    Private Const CONNECTION_STRING As String = "Report"
    Private Const REPORT_FILE_NAME As String = "report\source\HO\TandaBuktiPembayaranUlang.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/HO/TandaBuktiBayarUlang.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles TandaBuktiPembayaranUlangHOReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(TandaBuktiPembayaranUlangHOReportSource, CrystalReportSource)
        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)
        Me.TandaBuktiPembayaranReportUlangHOViewer.ReportSource = rs
        Me.TandaBuktiPembayaranReportUlangHOViewer.RefreshReport()
    End Sub
End Class
