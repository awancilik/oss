...
Partial Class TBPHO
    ...
    Private Const REPORT_FILE_NAME As String = "report\source\HO\TandaBuktiPembayaran.rpt"
    ...
    <Serializable()> Public Class Parameters
        ...
        Protected Overrides ReadOnly Property PageFileName() As String
            Get
                Return "../../../report/reportPage/HO/TandaBuktiPembayaran.aspx"
            End Get
        End Property
    ...
    Protected Sub MonthlyStockReportSource_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles TandaBuktiPembayaranHOReportSource.Init
    ...
    Private Sub RefreshReport(ByVal parameters As Parameters)
        Dim rs As CrystalReportSource = DirectCast(TandaBuktiPembayaranHOReportSource, CrystalReportSource)
        rs.ReportDocument.SetParameterValue("NoPermohonan", parameters.NoPermohonan)
        Me.TandaBuktiPembayaranReportHOViewer.ReportSource = rs
        Me.TandaBuktiPembayaranReportHOViewer.RefreshReport()
    End Sub
End Class
